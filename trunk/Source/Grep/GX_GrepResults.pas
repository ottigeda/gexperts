...
type
  ...
  TfmGrepResults = class(TfmIdeDockForm)
    ...
    miHamburgerFile: TMenuItem;
    miHamburgerList: TMenuItem;
    miHamburgerView: TMenuItem;
    miHamburgerReplace: TMenuItem;
    miHamburgerHelp: TMenuItem;
    miHamburgerFileSearch: TMenuItem;
    miHamburgerFileRefresh: TMenuItem;
    miHamburgerFileAbort: TMenuItem;
    N1: TMenuItem;
    miHamburgerFilePrint: TMenuItem;
    miHamburgerFileOpen: TMenuItem;
    N2: TMenuItem;
    N3: TMenuItem;
    miHamburgerFileSave: TMenuItem;
    miHamburgerFilePrintToFile: TMenuItem;
    miHamburgerFileSavePrint: TMenuItem;
    N4: TMenuItem;
    miHamburgerFileRefreshSelected: TMenuItem;
    N5: TMenuItem;
    miHamburgerFileDeleteSelected: TMenuItem;
    N6: TMenuItem;
    miHamburgerFileModifySaveOptions: TMenuItem;
    miHamburgerFileSearchInHistory: TMenuItem;
    miHamburgerGotoSelected: TMenuItem;
    miHamburgerGotoSelectedandClose: TMenuItem;
    miHamburgerSelectNext: TMenuItem;
    miHamburgerSelectPrevious: TMenuItem;
    N7: TMenuItem;
    miHamburgerCopy: TMenuItem;
    N8: TMenuItem;
    miHamburgerContract: TMenuItem;
    miHamburgerExpand: TMenuItem;
    miHamburgerOptions: TMenuItem;
    N9: TMenuItem;
    miHamburgerShowMatchContext: TMenuItem;
    miHamburgerShowHistoryList: TMenuItem;
    N10: TMenuItem;
    ShowFullFilename1: TMenuItem;
    miHamburgerShowIndent: TMenuItem;
    miHamburgerStayonTop: TMenuItem;
    N11: TMenuItem;
    miHamburgerReplaceAllItems: TMenuItem;
    miHamburgerReplaceSelectedItem: TMenuItem;
    miHamburgerHelpHelp: TMenuItem;
    miHamburgerHelpContents: TMenuItem;
