  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object CheckBox1: TCheckBox
          ...
          Width = 231
          Height = 17
          Caption = 'Code Generator ToolBar Visible'
          TabOrder = 0
        end
        object CheckBox2: TCheckBox
          ...
          Width = 231
          Height = 17
          Caption = 'Snippets ToolBar Visible'
          TabOrder = 1
        end
        ...
        object CheckBox13: TCheckBox
          ...
          Width = 216
          Height = 17
          Caption = 'Place JExperts menu under Tools'
          TabOrder = 4
        end
      end
      object GroupBox4: TGroupBox
        ...
        object CheckBox3: TCheckBox
          ...
          Width = 161
          Height = 17
          Caption = 'Automatically save files every '
          TabOrder = 0
        ...
        object ComboBox3: TComboBox
          ...
          Items.Strings = (
            'Save all files'
            'Save current file'
            'Save all files if existing physically'
            'Save current file if existing physically'
            'Just remind')
        end
        object CheckBox5: TCheckBox
          ...
          Width = 161
          Height = 17
          Caption = 'Do not ask confirmation'
          Enabled = False
          TabOrder = 2
        end
      end
      object GroupBox5: TGroupBox
        ...
        object CheckBox4: TCheckBox
          ...
          Width = 159
          Height = 17
          Caption = 'Preserve choosed disposition'
          TabOrder = 1
        end
      end
    end
    ...
    object TabSheet2: TTabSheet
      ...
      object GroupBox2: TGroupBox
        ...
        object JvFontBox1: TJvFontComboBox
          Left = 74
          Top = 114
          Width = 191
          Height = 22
          DroppedDownWidth = 191
          MaxMRUCount = 0
